...
export class BrandDiscountDto {
  ...
  @ApiProperty({
    ...
    description:
      'Array of brands with discount rules. Each item must have: brandName, percentage, minOrderValue, maxDiscount',
  })
  @IsNotEmpty({
    message:
      'brands field cannot be empty. Provide at least one brand with discount details.',
  })
