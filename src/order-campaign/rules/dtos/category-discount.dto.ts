...
export class CategoryDiscountDto {
  ...
  @ApiProperty({
    ...
    description:
      'Array of categories with discount rules. Each item must have: categoryName, percentage, minOrderValue, maxDiscount',
  })
  @IsNotEmpty({
    message:
      'categories field cannot be empty. Provide at least one category with discount details.',
  })
